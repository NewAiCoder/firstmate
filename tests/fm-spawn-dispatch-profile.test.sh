...
# crewmate launch deliberately drops. Every claude launch must therefore carry the
# policy itself, or a spawned worker writes Co-Authored-By and Claude-Session
# trailers into commits and PR bodies.
...
test_claude_crewmate_launch_carries_the_attribution_policy() {
  ...
  assert_contains "$launch" "--setting-sources project,local" \
    "this case only proves anything while the crewmate launch drops the user settings scope"
